...
#define WET_LEVEL 0.25f    // Volume do efeito (0.0 a 1.0).
#define DRY_LEVEL 0.75f    // Volume do som original (0.0 a 1.0).

// Configuração do Pitch Shifter
#define PITCH_FACTOR 2.0f // Mudan�a de tom
...
void main()
{
    ...
    file_out = fopen("../data/18_output.wav", "wb");
